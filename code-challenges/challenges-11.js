...
function gradesAvg(arr) {
        return arr.map((obj) => {
          const gradesSum = obj.gradsList.reduce((acc, grade) => acc + grade, 0);
          const avg = gradesSum / obj.gradsList.length;
          return { ...obj, avg }; // Spread operator to create new object with added property
        });
      }
// -------------------------------------------------------------------------------------------------------
