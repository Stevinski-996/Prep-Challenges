...
const objLat = (obj) => {
        ...
        let firstNameUpper = obj.firstName.charAt(0).toUpperCase() + obj.firstName.slice(1);
        let lastNameUpper = obj.lastName.charAt(0).toUpperCase() + obj.lastName.slice(1);
...
const cvFormatter = (cvs) => {
    const formattedCvs = []; // Array to store results
